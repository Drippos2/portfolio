      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="flex flex-col gap-2">
              {['home', 'about', 'services', 'projects', 'pricing', 'contact'].map((section) => (
                <button
                  ...
                  className="text-gray-400 hover:text-primary transition-colors duration-300 text-left text-sm"
                >
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                href="tel:0910151751"
                className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors duration-300 text-sm"
              >
              ...
              <div className="flex items-center gap-3 text-gray-400 text-sm cursor-default pt-1">
                <Building2 size={16} className="text-primary opacity-80" />
                <span>IČO: 57587752</span>
              </div>

              {/* DIČ SEKCIA */}
              <div className="flex items-center gap-3 text-gray-400 text-sm cursor-default">
                <FileCheck size={16} className="text-primary opacity-80" />
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-500 text-xs md:text-sm flex items-center gap-1.5">
            {translations.footer.madeWith} <Heart size={14} className="text-primary fill-primary animate-pulse" /> {translations.footer.by} DuoVision STUDIO
          </p>
        </div>
      </div>
    </footer>
